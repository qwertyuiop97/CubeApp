...
enum StickerDatabase {
    static func pattern(for caseID: String) -> StickerPattern? {
        ...
        case "OLL-21": return StickerPattern(uFace: [true,true,true,true,true,true,true,true,true], frontTop: [gray,gray,gray], rightTop: [gray,gray,gray], backTop: [gray,gray,gray], leftTop: [gray,gray,gray])
        case "OLL-22": return StickerPattern(uFace: [true,true,true,true,true,true,true,true,true], frontTop: [gray,gray,gray], rightTop: [gray,gray,gray], backTop: [gray,gray,gray], leftTop: [gray,gray,gray])
        case "OLL-23": return StickerPattern(uFace: [true,true,true,true,true,true,true,true,true], frontTop: [gray,gray,gray], rightTop: [gray,gray,gray], backTop: [gray,gray,gray], leftTop: [gray,gray,gray])
        case "OLL-24": return StickerPattern(uFace: [false,true,false,true,true,false,false,true,false], frontTop: [gray,gray,gray], rightTop: [gray,gray,gray], backTop: [gray,gray,gray], leftTop: [gray,gray,gray])
        case "OLL-25": return StickerPattern(uFace: [false,true,false,false,true,true,false,true,false], frontTop: [gray,gray,gray], rightTop: [gray,gray,gray], backTop: [gray,gray,gray], leftTop: [gray,gray,gray])
        case "OLL-26": return StickerPattern(uFace: [true,false,false,true,true,false,true,false,false], frontTop: [gray,gray,gray], rightTop: [gray,gray,gray], backTop: [gray,gray,gray], leftTop: [gray,gray,gray])
        case "OLL-27": return StickerPattern(uFace: [false,false,true,false,true,true,false,false,true], frontTop: [gray,gray,gray], rightTop: [gray,gray,gray], backTop: [gray,gray,gray], leftTop: [gray,gray,gray])
